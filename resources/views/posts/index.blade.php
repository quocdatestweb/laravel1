                        ...
                        <div class="widget-body" >
                            <div class="widget-top-overflow text-white">
                                ...
                                <ul class="tags text-white pull-right">
                                    <li><a href="#">{{ $post->author_type }}</a></li>
                            ...
                            <div class="post-user mt-sm">
                                ...
                                <h5 class="mb-xs mt-xs"> <a href="{{ route('showpost', ['id' => $post->id]) }}">
                                    <span class="fw-semi-bold">{{ $post->name }}</span></a></h5>
                                <p class="fs-mini text-muted"><time>Created at: {{ $post->created_at }}</time> &nbsp; </p>
                            </div>
