                        ...
                        <div class="card-body">
                            <div class="row gutters">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <h6 class="mb-2 text-danger">Product Details</h6>
                                </div>
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="form-group">
                                        <h6 class="text-success" for="phone">Detail</h6>
                                        <br>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <h6 class="text-primary" for="phone">Name</h6>
                                        <br>
                                        {{ $products->Name }}
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <h6 class="text-primary" for="phone">Price</h6>
                                        <br>
                                        {{ $products->Price }}
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <h6 class="text-primary" for="phone">Author</h6>
                                        <br>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <h6 class="text-primary" for="phone">Author ID</h6>
                                        <br>
                                        {{ $products->Author_ID }}
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <h6 class="text-primary" for="phone">Date</h6>
                                        <br>
                                        {{ $products->created_at }}
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="text-right">
                                        <button type="button" id="submit" name="submit"
                                            class="btn btn-primary">Buy it</button>
                                    </div>
                                </div>
                            </div>
                        </div>
